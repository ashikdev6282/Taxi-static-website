    ...
    return (
        <div className="about-container fade-in">
            ...
            <div className="services-section fade-in">
                ...
                <div className="fleet">
                    <div className="fleet-item fade-in">
            ...
            <div className="why-choose-us fade-in">
                <div className="why-choose-us-content fade-in">
            ...
            <div className="contact-section fade-in" style={{ color: "white" }}>
            ...
            <div className="follow-section fade-in">
